...
| --- | ---: | ---: | ---: |
| Astra-written controller (this evaluation) | $21.3\pm5.8$ | $22.0\pm0.0$ | $2.7\pm1.2$ |
...
| Policy | Hammer Nail | Water Plant | Microwave Cook (two arms) |
| --- | ---: | ---: | ---: |
| Astra-written controller (this evaluation) | $6.7\pm4.6$ | $22.0\pm5.3$ | $1.3\pm1.2$ |
...
The evaluated controller uses 100 official training demonstrations for each task and condition. All six reported means are below the five reference policies. This comparison does not establish paired statistical significance or measure the best performance achievable by Astra.
